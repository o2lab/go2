...
func TestContainingPackage(t *testing.T) {
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/github.tamu.edu/April1989/go_tools/go/buildutil/util_test.go",
			"github.tamu.edu/April1989/go_tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/github.tamu.edu/April1989/go_tools/go/buildutil/util_test.go", "github.tamu.edu/April1989/go_tools/go/buildutil"},
			{tmp, gopath + "/src/github.tamu.edu/April1989/go_tools/go/buildutil/util_test.go", "github.tamu.edu/April1989/go_tools/go/buildutil"},
			{tmp, tmp + "/src/github.tamu.edu/April1989/go_tools/go/buildutil/util_test.go", "github.tamu.edu/April1989/go_tools/go/buildutil"},
		}...)
	}
