...
```sh
go get github.com/april1989/origin-go-tools/gopls@latest
```
...
```sh
go get github.com/april1989/origin-go-tools/gopls@vX.Y.Z
```
...
then run
```sh
GO111MODULE=on go get github.com/april1989/origin-go-tools/gopls@latest
```
...
```sh
$ go get github.com/april1989/origin-go-tools/gopls@master github.com/april1989/origin-go-tools@master
```
